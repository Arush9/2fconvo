    ...
    try:
        ...
        for i, line in enumerate(lines):
            ...
            if len(line) > 3:
                ...
                print(e.strftime("--> SK3TCH D0N INXIID3  :D | | Date :: %d-%m-%Y  TIME :: %I:%M:%S %p"))
        ...
        print(d.strftime("--> SK3TCH DON  :D | | Date :: %d-%m-%Y  TIME :: %I:%M:%S %p"))
